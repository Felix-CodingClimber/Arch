...
public partial class QueryTest
{
    ...
    public void GeneratedQueryTest()
    {
        ...
        var queryCount = 0;
        _world.Query<Transform>(in _withoutAiQuery, (in Entity entity, ref Transform t) => queryCount++);
    ...
    public void GeneratedParallelQueryTest()
    {
        ...
        var queryCount = 0;
        _world.ParallelQuery<Transform>(in _withoutAiQuery, (in Entity entity, ref Transform t) => Interlocked.Increment(ref queryCount));
